...
public class Constants {
    ...
    // Opciones Genericas
    public static final String SALIR_MENU = "0 -Salir del Menu...";
    public static final String OPCION_NO_VALIDA = "Opcion no valida";
    
    // Cabeceras menu
    public static final String CABECERA_CREAR_PACIENTE = "Introduce los datos del Paciente";
    ...
    public static final String PACIENTE_PASW = "Contrasenya Ej. 12341234";
